...
async function cmdCreate(appName, opts, usage) {
  ...
  // Icon provider resolution: lucide (Svelte only), heroicons (Phoenix), or font-awesome (default)
  ...
  else { iconProvider = 'font-awesome'; iconProviderSource = 'default (none loaded)'; }
  ...
  // Collect valid feature flags from recipe.features
