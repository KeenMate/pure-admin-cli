...
function collectProfileItems(ctx) {
  ...
  // Default profile nav items
  return [
    { href: '#', label: 'Profile Settings', icon: 'fa-solid fa-user' },
    { href: '#', label: 'Security', icon: 'fa-solid fa-lock' },
    { href: '#', label: 'Notifications', icon: 'fa-solid fa-bell' },
    { href: '#', label: 'Preferences', icon: 'fa-solid fa-gear' },
  ];
}
