...
function usage(error) {
  ...
  ${bold('Theme commands:')}
    ...
    themes show <id>            Show theme details, versions, core compat
  ...
  ${bold('Config commands:')}
    ...
    profiles delete <id>        Remove a company profile
    presets list                List saved create presets
    presets show <name>         Show preset details
    presets delete <name>       Remove a preset
  ...
  ${bold('Examples:')}
    pureadmin create                                          ${dim('interactive wizard')}
    pureadmin create my-app --template svelte-spa              ${dim('direct create')}
    pureadmin themes list                                     ${dim('all themes from API')}
    pureadmin themes list --local                             ${dim('project themes')}
    pureadmin themes show audi                                ${dim('theme details')}
    pureadmin themes add express dark                         ${dim('add to project')}
    pureadmin themes build                                    ${dim('build all')}
    pureadmin themes publish                                  ${dim('pack + upload')}
    pureadmin templates list                                  ${dim('available templates')}
    pureadmin profiles list                                   ${dim('company profiles')}
    pureadmin presets list                                    ${dim('saved presets')}
`);
